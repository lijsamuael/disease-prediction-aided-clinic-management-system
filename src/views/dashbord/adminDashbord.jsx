...
export default function AdminDashbord(props) {
  ...
  const currentAdmin = useSelector((state) => state.currentUser.currentAdmin);
        ...
        <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white dark:bg-gray-700 text-black dark:text-white">
          <div class="fixed w-full flex items-center justify-between h-14 text-white z-10">
            <div class="flex items-center justify-start md:justify-center pl-3 w-14 md:w-64 h-14 bg-blue-800 dark:bg-gray-800 border-none">
              <img
                class="rounded-full mr-2 w-10 h-10 relative object-cover"
            ...
            <div class="flex justify-end items-center h-14 bg-blue-800 dark:bg-gray-800 header-right">
              ...
              <ul class="flex items-center">
                ...
                <li>
                  <Link
                    to="/adminDashbord/forgetPassword"
              ...
              <div class="bg-blue-500 dark:bg-gray-800 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-blue-600 dark:border-gray-600 text-white font-medium group">
                <div class="flex justify-center items-center w-14 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:rotate-12">
                  ...
                  <img
                    ...
                    alt=""
                    class="w-8 h-8 rounded-full h-30 stroke-current bg-blue-500 text-blue-800 dark:text-gray-800 transform transition-transform duration-500 ease-in-out"
                  />
                </div>
                <div class="text-right">
