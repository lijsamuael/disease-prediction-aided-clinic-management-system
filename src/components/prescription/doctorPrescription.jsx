  ...
  return (
    <div className="px-[5%] flex flex-col justify-center items-center py-16 font-mono">
      <div className="flex justify-between gap-16 px-12 py-16 bg-blue-400">
        <div>
          <h1 className="text-3xl font-bold tracking-widest">MediConnect</h1>
          <p>
            This is an officail MediConnect Prescription Card, It is the only
            communication medium between a Doctor and a Laboratoriest.
          </p>
        </div>
        <div>
